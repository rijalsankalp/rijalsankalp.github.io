export default function GradleLab() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        <h3 className="font-bold text-lg">Gradle Lab</h3>
        <a
          href="https://github.com/rijalsankalp/gradle-lab"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Java | Gradle | Build Automation | Dependency Management
      </p>
      <p className="text-sm">
        Technical repository demonstrating Gradle build automation for Java
        projects, including custom build scripts, multi-module configuration,
        dependency resolution, and integration with CI/CD pipelines. Covers
        advanced Gradle features such as task configuration, plugin usage, and
