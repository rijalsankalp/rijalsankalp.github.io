export default function SnakeAndLadder3D() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        <h3 className="font-bold text-lg">Snake and Ladder 3D</h3>
        <a
          href="https://github.com/rijalsankalp/snake-and-ladder"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        C++ | OpenGL | GLUT | 3D Graphics | Animation | Game Logic
      </p>
      <p className="text-sm">
        Engineered a 3D snake and ladder board game using C++ and OpenGL,
        featuring custom graphics pipeline, smooth animations, and interactive
        gameplay logic. The project includes camera controls, event-driven user
        input, and extensible game state management for enhanced player
        experience.
      </p>
    </div>
  );
