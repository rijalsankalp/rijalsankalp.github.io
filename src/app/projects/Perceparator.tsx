export default function Perceparator() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        ...
        <a
          href="https://github.com/rijalsankalp/perceparator"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Python | PyTorch | ML | Speech Separation | Transformer
      </p>
      <p className="text-sm">
        Developed a speech separation model using Transformer architecture with
        efficient computational complexity. Evaluated literature reviews,
        designed and implemented a novel architecture based on pervceiver model.
        Achieved a SI-SNRi score of 10.5dB on the WSJ0-2mix dataset.
      </p>
    </div>
  );
}
