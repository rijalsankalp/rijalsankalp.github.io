export default function ImageCaptionGeneration() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        <h3 className="font-bold text-lg">Image Caption Generation</h3>
        <a
          href="https://github.com/rijalsankalp/ImageCaptionGeneration"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Jupyter Notebook | Python | PyTorch | Vision Transformer | GPT-2 |
        Multimodal Learning
      </p>
      <p className="text-sm">
        Implemented a multimodal image captioning system using Vision
        Transformer for visual feature extraction and GPT-2 for natural language
        generation. The project covers data preprocessing, model training,
        cross-modal attention mechanisms, and evaluation using ROGUE scores.
        Includes experiments with transfer learning and fine-tuning for improved
        caption quality.
      </p>
    </div>
  );
