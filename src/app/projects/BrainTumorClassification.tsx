export default function BrainTumorClassification() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        <h3 className="font-bold text-lg">Brain Tumor Classification</h3>
        <a
          href="https://github.com/rijalsankalp/Brain-Tumor-Classification"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Jupyter Notebook | Python | TensorFlow | Keras | Grad-CAM | Medical
        Imaging
      </p>
      <p className="text-sm">
        Built and trained convolutional neural networks for automated
        classification of brain tumors from MRI scans. Integrated Grad-CAM for
        model interpretability, enabling visualization of salient regions in
        medical images. The workflow includes preprocessing, augmentation,
        hyperparameter tuning, and performance evaluation on clinical datasets.
      </p>
    </div>
  );
}
