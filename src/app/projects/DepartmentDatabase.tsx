export default function DepartmentDatabase() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        <h3 className="font-bold text-lg">Department Database</h3>
        <a
          href="https://github.com/rijalsankalp/DepartmentDatabase"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        HTML | SQL | Python | Relational Database Design | ER Modeling |
        Normalization
      </p>
      <p className="text-sm">
        Designed and implemented a normalized relational database for a
        government office, including requirement analysis, ER diagrams,
        relational schema, data dictionary, stored procedures, and complex SQL
        queries. The project demonstrates advanced normalization techniques and
        integration with a Python-based application layer for data management
        and reporting.
      </p>
    </div>
  );
