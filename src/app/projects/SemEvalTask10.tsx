export default function SemEvalTask10() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        <h3 className="font-bold text-lg">SemEval Task 10</h3>
        <a
          href="https://github.com/rijalsankalp/semevaltask10"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Jupyter Notebook | Python | NLP | Semantic Evaluation | Benchmarking
      </p>
      <p className="text-sm">
        Technical repository for SemEval Task 10, featuring semantic evaluation
        of NLP models on benchmark datasets. Includes preprocessing, feature
        extraction, model training, and comparative analysis of state-of-the-art
        algorithms. Results are visualized and interpreted for linguistic
        insights and task-specific performance.
      </p>
    </div>
  );
}
