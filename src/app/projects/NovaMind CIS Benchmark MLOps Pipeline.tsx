export default function NovaMindCISBenchmarkMLOpsPipeline() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        ...
        <a
          href="https://github.com/rijalsankalp/llms-final-project"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Python | PyTorch | FastAPI | AWS| Docker | CI/CD | MLOps
      </p>
      <p className="text-sm">
        Designed an automated MLOps pipeline using GitHub Actions and AWS
        SageMaker to fine-tune and deploy Qwen2.5 LLMs for CIS security
        benchmarks, utilizing Managed Spot Instances to reduce training costs by
        70% and Serverless Inference for scalable, cost-effective deployment.
        Implemented PEFT with LoRA and Hugging Face TRL to adapt the
        Qwen2.5-0.5B-Instruct model, optimizing training with Flash Attention 2
        and BF16 precision while tracking BLEU, ROUGE via wandb.
      </p>
    </div>
  );
}
