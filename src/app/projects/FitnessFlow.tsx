export default function FitnessFlow() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        <h3 className="font-bold text-lg">FitnessFlow</h3>
        <a
          href="https://github.com/rijalsankalp/FitnessFlow"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Next.js | React | Tailwind CSS | Firebase | Dashboard Analytics |
        Cross-Platform
      </p>
      <p className="text-sm">
        Engineered a cross-platform fitness tracking application with Next.js
        and Firebase backend. Includes real-time data sync, interactive
        dashboards, progress analytics, and habit/routine management. The UI
        leverages Tailwind CSS for responsive design and modern user experience.
      </p>
    </div>
  );
}
