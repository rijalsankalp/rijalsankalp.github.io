export default function HandwrittenDevanagariCharacterRecognition() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        ...
        <a
          href="https://github.com/rijalsankalp/Handwritten-Devanagari-Character-Recognition"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Jupyter Notebook | Python | TensorFlow | Keras | OpenCV | Computer
        Vision
      </p>
      <p className="text-sm">
        Developed a deep learning pipeline for handwritten Devanagari character
        recognition, including custom dataset creation, image preprocessing with
        OpenCV, and CNN architecture design. The project features data
        augmentation, training visualization, and evaluation of model accuracy
        and generalization on unseen samples.
      </p>
    </div>
  );
}
