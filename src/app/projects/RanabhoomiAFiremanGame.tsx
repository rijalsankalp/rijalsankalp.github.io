export default function RanabhoomiAFiremanGame() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        <h3 className="font-bold text-lg">Ranabhoomi-A Fireman Game</h3>
        <a
          href="https://github.com/rijalsankalp/Ranabhoomi-A-Fireman-Game"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        C++ | SFML | Object-Oriented Design | Real-Time Graphics | Multiplayer
      </p>
      <p className="text-sm">
        Designed and implemented a multiplayer fireman-themed game using C++ and
        SFML. Features custom sprite management, real-time graphics rendering,
        event-driven architecture, and networked multiplayer logic. Includes
        collision detection, animation systems, and extensible game mechanics
