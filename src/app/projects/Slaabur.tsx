export default function Slaabur() {
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 flex flex-col gap-3 border border-blue-200 dark:border-gray-700">
      <div className="flex items-center gap-2 mb-1">
        <h3 className="font-bold text-lg">Slaabur: History Matters</h3>
        <a
          href="https://github.com/rijalsankalp/Slaabur"
          target="_blank"
          rel="noopener"
          className="ml-1"
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        React | Tailwind CSS | Data Visualization | Timeline Rendering |
        Interactive UI
      </p>
      <p className="text-sm">
        Developed a web application for historical data visualization using
        React and Tailwind CSS. Features custom timeline rendering, interactive
        filtering, and dynamic storytelling components. The architecture
        supports scalable data integration and responsive design for rich user
        experiences.
      </p>
    </div>
  );
