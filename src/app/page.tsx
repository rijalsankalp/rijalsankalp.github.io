...
export default function Home() {
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <aside className="w-64 min-h-screen bg-gradient-to-br from-blue-100 via-white to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 shadow-lg flex flex-col items-center py-10 px-6 gap-8 border-r border-blue-200 dark:border-gray-700 sticky top-0 h-screen">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
            Bryn Mawr, PA
            <br />
            <a href="mailto:rijalsankalp@gmail.com" className="underline">
              rijalsankalp@gmail.com
            </a>
            <br />
